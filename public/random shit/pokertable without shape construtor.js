 ...
 function Item(x,y,width,height,imageSource){
     this.position = {}
this.position.x = x
this.position.y = y
this.size = {}
...
if(imageSource){
    ...
    this.tempImage.src = imageSource
}
            }
    ...
    holdemCanvas.images.defaultImages = function (){
        ...
        holdemCanvas.images.seats[i].seat = {}
    ...
    for (var i=0;i<holdemCanvas.images.seats.length;i=i+1){
        ...
        //action buttons
         holdemCanvas.images.fold.tempImage = new Image()
        holdemCanvas.images.fold.tempImage.src = holdemCanvas.images.sources.fold
        holdemCanvas.images.fold.bitmap = new createjs.Bitmap(holdemCanvas.images.fold.tempImage)
        
         holdemCanvas.images.call.tempImage= new Image
        holdemCanvas.images.call.tempImage.src = holdemCanvas.images.sources.call
        holdemCanvas.images.call.bitmap = new createjs.Bitmap(holdemCanvas.images.call.tempImage)
 
        holdemCanvas.images.check.tempImage= new Image()
        holdemCanvas.images.check.tempImage.src =  holdemCanvas.images.sources.check
         holdemCanvas.images.check.bitmap = new createjs.Bitmap( holdemCanvas.images.check.tempImage)

        holdemCanvas.images.raise.tempImage= new Image()
        holdemCanvas.images.raise.tempImage.src =  holdemCanvas.images.sources.raise
        holdemCanvas.images.raise.bitmap = new createjs.Bitmap(holdemCanvas.images.raise.tempImage)
        
        holdemCanvas.images.bet.tempImage= new Image()
        holdemCanvas.images.bet.tempImage.src =  holdemCanvas.images.sources.bet
        holdemCanvas.images.bet.bitmap = new createjs.Bitmap(holdemCanvas.images.bet.tempImage)

         //seats and corresponding hole cards
        for (var i = 0; i < holdemCanvas.images.seats.length; i = i + 1){

            holdemCanvas.images.seats[i].seat.tempImage= new Image()
            holdemCanvas.images.seats[i].seat.tempImage.src = holdemCanvas.images.sources.blankSeat
            holdemCanvas.images.seats[i].seat.bitmap = new createjs.Bitmap(holdemCanvas.images.seats[i].seat.tempImage)

            holdemCanvas.images.seats[i].hiddenCard0.tempImage= new Image()
            holdemCanvas.images.seats[i].hiddenCard1.tempImage= new Image()
            holdemCanvas.images.seats[i].hiddenCard0.tempImage.src = holdemCanvas.images.sources.hiddenCard
            holdemCanvas.images.seats[i].hiddenCard1.tempImage.src = holdemCanvas.images.sources.hiddenCard

            holdemCanvas.images.seats[i].hiddenCard0.bitmap = new createjs.Bitmap(holdemCanvas.images.seats[i].hiddenCard0.tempImage)
            holdemCanvas.images.seats[i].hiddenCard1.bitmap = new createjs.Bitmap(holdemCanvas.images.seats[i].hiddenCard1.tempImage)

            holdemCanvas.images.seats[i].shownCard0.tempImage= new Image()
            holdemCanvas.images.seats[i].shownCard1.tempImage= new Image()
            ...
            holdemCanvas.images.seats[i].shownCard0.bitmap = new createjs.Bitmap(holdemCanvas.images.seats[i].shownCard0.tempImage)
            holdemCanvas.images.seats[i].shownCard1.bitmap = new createjs.Bitmap(holdemCanvas.images.seats[i].shownCard1.tempImage)

        }

        for (var i = 0; i < 3; i = i + 1){
         holdemCanvas.images.leftSideButtons[i].tempImage= new Image()
         holdemCanvas.images.leftSideButtons[i].tempImage.src = holdemCanvas.images.sources.sideButton
         holdemCanvas.images.leftSideButtons[i].bitmap = new createjs.Bitmap(holdemCanvas.images.leftSideButtons[i].tempImage)
         }
        //community cards
        for (var i = 0; i < 5; i = i + 1){

         holdemCanvas.images.community[i].tempImage= new Image()
            holdemCanvas.images.community[i].tempImage.src = holdemCanvas.images.sources.shownCard
             holdemCanvas.images.community[i].bitmap = new createjs.Bitmap(holdemCanvas.images.community[i].tempImage)
      ...
      holdemCanvas.images.check.position = {
        ...
        for (var i = 0; i < holdemCanvas.images.seats.length; i = i + 1)
        {
            holdemCanvas.images.seats[i].hiddenCard0.position = {
                x: holdemCanvas.images.seats[i].seat.position.x - 1,
                y: holdemCanvas.images.seats[i].seat.position.y - 68
            }
            holdemCanvas.images.seats[i].hiddenCard1.position = {
                x: holdemCanvas.images.seats[i].seat.position.x + 45,
                y: holdemCanvas.images.seats[i].seat.position.y + -68
            }
         ...
         for (var i in holdemCanvas.images)
        {
            if (typeof holdemCanvas.images[i] === 'object')
            {
                ...
                for(var i = 0;i<holdemCanvas.images.community.length;i=i+1){
                    ...
                    for(var i = 0; i<holdemCanvas.images.seats.length;i=i+1){
                        holdemCanvas.images.seats[i].seat.bitmap.x = holdemCanvas.images.seats[i].seat.position.x
                        holdemCanvas.images.seats[i].seat.bitmap.y =  holdemCanvas.images.seats[i].seat.position.y
...
holdemCanvas.images.leftSideButtons[i].size = {
        ...
        for (i = 0; i < holdemCanvas.images.seats.length; i = i + 1){
            holdemCanvas.images.seats[i].seat.size = {
            x: 90,
            y: 33
            }
...
holdemCanvas.images.defaultMessages = function(){
    ...
    holdemCanvas.images.call.messages[0] = 'act'
     ...
     holdemCanvas.images.check.messages[0] = 'act'
      ...
      for(i=0;i<holdemCanvas.images.seats.length;i=i+1){
         holdemCanvas.images.seats[i].seat.messages[0] = 'sit'
         holdemCanvas.images.seats[i].seat.messages[1] = i
         }
   ...
   holdemCanvas.images.displayAllCommunity = function(communityArray){
    ...
    holdemCanvas.images.displayAll = function ()
    {
        ...
        for (var i = 0; i < holdemCanvas.images.seats.length; i = i + 1)
        {
            ...
            holdemCanvas.images.displayImage(holdemCanvas.images.seats[i].seat)
      ...
      for (var i in holdemCanvas.images)
        {
            if (typeof holdemCanvas.images[i] === 'object')
            {
                if (holdemCanvas.images[i].tempImage)
                {
...
jQuery(document).ready(function(){
    ...
    jQuery(window).load(function ()
    {
       ...
       for (var i = 0;i<holdemCanvas.images.seats.length;i=i+1){
       holdemCanvas.images.activateButton (['sit',i],holdemCanvas.images.seats[i].seat)}
