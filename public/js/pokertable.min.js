...
//disable click on raise/bet image
 // $(self.images.raise.image, self.images.bet.image).one('mousedown.disableOneRaiseOrBetClick', disableOneRaiseOrBetClick)
$('self.images.raise.image, self.images.bet.image').one('click.preventOneClick', function(e){e.preventDefault})
$('self.images.raise.image, self.images.bet.image').one('mouseup.restoreClick', function(e){e.preventDefault(); enableRaiseAndBetEvents()})
...
$('self.images.raise.image, self.images.bet.image').off('mousedown.disableOneRaiseOrBetClick click.preventOneClick mouseup.restoreClick')
}
