...
var tableChatFullRoundedRectCornerSizeRatioOfHeight = 0.05
  ...
  this.tableChatFull.window.draw = function(){ //we can use this function to update when we popout the chat box
...
.drawRoundRect(this.tableChatFull.window.position.x, this.tableChatFull.window.position.y, width, height, tableChatFullRoundedRectCornerSizeRatioOfHeight*this.tableChatFull.window.size.y)
this.tableChatFull.window.image.alpha = tableChatFullWindowAlpha

  }

  this.tableChatFull.window.draw()
...
//popout the tablechatfull display if necessary
if(self.sessionPreferences.tableChatFull.defaultItemsToHideFalseHidesItem['popOut'].value === false){

var stageParent = self.getParentOfStageObject (self.images.tableChatFull.window)

var newHeight = self.jQueryObjects.canvasDiv.getOuterHeight(true)
...
$(stageParent.stage.canvas).attr('height', newHeight).css({'left':0,'top':0})
self.jQueryObjects.pokerTableWrapper.prepend(stageParent.div)
...
var newHeight = self.images.tableChatFull.htmlElement.size.y
var newX =  self.images.tableChatFull.htmlElement.position.x
var newY = self.images.tableChatFull.htmlElement.position.y
