...
'user-select': 'none',
 ...
 'width': 'auto'   //          this.tableChatFull.chatTextDiv.size.x+'px',
'height': 'auto'   //            this.tableChatFull.chatTextDiv.size.y+'px',
...
var newHeight = self.jQueryObjects.canvasDiv.getOuterHeight(true) - self.images.chatBox.position.y
var newX = 0; var newY = 0
var prependTo = self.jQueryObjects.pokerTableWrapper
var position = 'relative'


}//popout tablechatfull

else if ($(tableChatFullStageParent.div).parent().is(self.jQueryObjects.canvasDiv)){//variables for popping in
