...
self.updateStages(stagesToUpdate)
      ...
      tableChatFull:{
      scrollBarType :   {value:'niceScroll'},
        chatMessageFontSize: {
          value:11 , 
...
this.moveTableChatFullMessageText = function(movementObject, options){
  ...
  if(!_.isNumber(movementObject.magnitude)){    
    ...
    if(self.permanentPreferences.tableChatFull.scrollBarType && self.permanentPreferences.tableChatFull.scrollBarType.value == 'mCustomScrollbar'){
      ...
      console.log('self.jQueryObjects... is ', self.jQueryObjects.tableChatFullDiv.mCustomScrollbar);
  ...
  if(_.isNumber(movementObject.magnitude)){
    if(self.permanentPreferences.tableChatFull.scrollBarType && self.permanentPreferences.tableChatFull.scrollBarType.value == 'mCustomScrollbar'){
      //Bobby: "What is supposed to happen in here?"
    }//if mcustomscrollbar
...
if(self.permanentPreferences.tableChatFull.scrollBarType && self.permanentPreferences.tableChatFull.scrollBarType.value == 'mCustomScrollbar'){
  ...
  console.log('creating niceScroll')
...
self.jQueryObjects.canvasDiv.append('<canvas id = '+'\''+newCanvasID+'\'' + ' width = '+'\''+canvasWidth+'\''+' height=' +'\''+canvasHeight+'\''+'></canvas>')
...
//self.jQueryObjects.tableChatFullDiv.mCustomScrollbar(mCustomScrollbarOptions)
console.log('assigning isAtBottom is true because i dont know how to do it on mcustomscrollbar')
