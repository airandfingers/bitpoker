...
this.images.Item.prototype.addBootstrapButton = function (id, buttonText, options){
if(!options){var options = {}}
...
//numbers only
$(this.cashier.otherAmount.image).numeric(cashierTextBoxNumericOptions)
...
console.log('aplying numeric to the following element')
console.log($(this.cashier.autoRebuyAmount.image))
//numbers only
$(this.cashier.autoRebuyAmount.image).numeric()
//$(this.cashier.autoRebuyAmount.image).numeric(cashierTextBoxNumericOptions)
...
var autoRebuyButtonText = 'Auto-Rebuy'
var cashierButtonTextSizeAndFont = '11px ' + self.permanentPreferences.defaultFontType.value
var cashierButtonHeight = 22
...
var autoRebuyButtonWidth = self.getStringWidth(autoRebuyButtonText, cashierButtonTextSizeAndFont)/cashierRatioOfTextWidthToButtonWidth
...
if(self.sessionPreferences.cashier && self.sessionPreferences.cashier.autoRebuyOption && self.sessionPreferences.cashier.autoRebuyOption.value === false){

var distanceBetweenCashierButtons = (innerCashierWidth - cashierButtonWidth*2)/3

console.log('creating cashier according to ' + self.sessionPreferences.cashier.autoRebuyOption.value)
...
}//if no autorebuy option

else{

//update width
if (cashierButtonWidth < autoRebuyButtonWidth){
var cashierButtonWidth = autoRebuyButtonWidth}
...
var autoRebuyButtonX = cancelX + distanceBetweenCashierButtons + cashierButtonWidth


  this.cashier.autoRebuyButton =  new this.Item (autoRebuyButtonX, cashierButtonY, cashierButtonWidth,cashierButtonHeight,{stage:cashierStageNumber, container:cashierImageContainerIndex}) 
 this.cashier.autoRebuyButton.addBootstrapButton('autoRebuyButton', 'Auto-Rebuy', cashierButtonOptions)

//click events
$(this.cashier.autoRebuyButton.image).off('click')
$(this.cashier.autoRebuyButton.image).on('click', function(e){
console.log('autorebuy clicked')
  console.log(e)
})//autorebuy button onclick event


}//if we gonna create cashier buttons with autorebuy button
...
if(_.isObject(item.image)){
  setDisplayObjectPosition(item.image, item.position.x, item.position.y)
}
