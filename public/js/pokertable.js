...
*/
    ...
    holdemCanvas.images.displayFaceUpCard = function (cardText,parentOfImageObject){

         parentOfImageObject.image.src = holdemCanvas.images.sources.blankCard
         parentOfImageObject.image.onload = function(){
            
            holdemCanvas.context.drawImage(parentOfImageObject.image, parentOfImageObject.position.x, parentOfImageObject.position.y)
    ...
    holdemCanvas.images.playerSits = function(seatNumber, playerName, chips){
        ...
        holdemCanvas.images.seats[seatNumber].image.onload = function(){
           ...
           holdemCanvas.context.drawImage(holdemCanvas.images.seats[seatNumber].image, holdemCanvas.images.seats[seatNumber].position.x, holdemCanvas.images.seats[seatNumber].position.y)
    ...
    holdemCanvas.images.displayHoleCards = function (card0,card1){
        ...
        holdemCanvas.images.displayFaceUpCard(card0, holdemCanvas.images.seats[holdemCanvas.userSeatNumber].card0)
        holdemCanvas.images.displayFaceUpCard(card1, holdemCanvas.images.seats[holdemCanvas.userSeatNumber].card1)
   ...
   holdemCanvas.images.displayAllCommunity = function(communityArray){
    ...
    holdemCanvas.images.displayFaceUpCard(communityArray[i], holdemCanvas.images.community[i])
...
/*    holdemCanvas.images.displayCurrentTableState=function(){
        ...
        if(user && dealtin){
            holdemCanvas.images.displayFaceUpCard(card0, holdemCanvas.images.seats[i].card0)
            holdemCanvas.images.displayFaceUpCard(card1, holdemCanvas.images.seats[i].card1)}
        else if(dealtin){
